...
public class CameraFake  implements CameraInterface{
	...
	//K, D, np.eye(3), K, DIM, 
		...
		// D = distCoeffs    
		  double[][] dArray = new double[][]{{0.4108889201891428},{-0.0029018582999649468},{-0.019218620930577385},{-0.2094587331452949}};
		  Mat d = new Mat(4,1,CvType.CV_8UC1);
		    ...
		    System.out.println("TYHIS");

			// K = cameraMatric
		    // ([[502.26087138645096, 0.0, 358.7882796447911], [0.0, 502.1027412727765, 244.26495016375978], [0.0, 0.0, 1.0]])
			  double[][] kArray = new double[][]{{502.26087138645096, 0.0, 358.7882796447911},{0.0, 502.1027412727765, 244.26495016375978},{0.0, 0.0, 1.0}};
		...
		Imgproc.initUndistortRectifyMap(k, d, eye, k, frame.size(), CvType.CV_16SC2, map1, map2);		
